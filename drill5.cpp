...
int main()
{
    ...
    //Cout << "Success!!\n";
    cout << "Success!\n";
    //2 Hiba: " jel lemaradt a végérõl
    //cout << "Success!\n;
    cout << "Success!\n";
    //3 Hiba: " jel lemaradt a ! elõl és nincs a végén ;
    //cout << "Success" << !\n"
    cout << "Success" << "!\n";
    ...
    //bool c = false;
    if(c) cout << "Success!\n"; else cout << "Fail!\n";
    //9 Hiba: bool helyett boo van írva, ape elõrébb van az abcben mint fool, ezért az if nem igaz
    //string s = "ape";
    string s = "xape";
    //boo c = "fool" < s;
    bool d = "fool" < s;
    ...
    //11 Hiba: ape nem fool emiatt false lesz az if, cout után kettõ < jel szükséges
    //string e = "ape";
    string e = "fool";
    ...
    //20 Hiba: végtelen ciklus, az ia sosem nõ, helyette a ja nõ, így az ia sosem lesz egyenlõ vagy nagyobb 10-el
    int ia=0;
    int ja=9;
    while(ia<10)
    {
